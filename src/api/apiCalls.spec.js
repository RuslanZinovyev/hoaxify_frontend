...
describe("apiCalls", () => {
  ...
  describe("listUser", () => {
    ...
    it("calls /api/1.0/users?page=5&size=10 when no corresponding param provided for listUsers", () => {
      const mockListUsers = jest.fn();
      axios.get = mockListUsers;
    ...
    it("calls /api/1.0/users?page=5&size=10 when only size param provided for listUsers", () => {
      const mockListUsers = jest.fn();
      axios.get = mockListUsers;
