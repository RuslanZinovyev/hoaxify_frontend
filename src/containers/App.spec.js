...
describe("App", () => {
  ...
  it("displays UserignupPage when url is /signup", () => {
  ...
  it("displays topBar when url os /", () => {
  ...
  it("displays topBar when url os /login", () => {
    const { container } = setup("/login");
    const navigation = container.querySelector("nav");
  ...
  it("displays topBar when url os /signup", () => {
    const { container } = setup("/signup");
    const navigation = container.querySelector("nav");
  ...
  it("displays topBar when url os /user1", () => {
  ...
  it("saves logged in user data to local after login success", async () => {
    const { queryByPlaceholderText, container, queryByText } = setup("/login");
    const usernameInput = queryByPlaceholderText("Your username");
    fireEvent.change(usernameInput, changeEvent("user1"));
    const passwordInput = queryByPlaceholderText("Your password");
